...
`,
  ...
  return (
    <div className="drones-page">
      <div className="drones-title">{drones.title}</div>
      <div className="drones-content">

        <div className="drones-description">{drones.description}</div>

        {drones.images.map((image) => (
          <div className="img">
            <img src={image} alt={drones.title} />
          </div>
        ))}
      </div>
